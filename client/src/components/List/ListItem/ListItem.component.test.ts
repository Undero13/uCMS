...
describe("ListItem component", () => {
  ...
  const wrapper3 = shallowMount(ListItem, { props: { item: itemWithDropdown } });
  ...
  test('it can render html', () => {
    ...
    expect(wrapper3.html().includes("<li class=\"navbar-item has-dropdown is-hoverable\"><button class=\"button-menu\" aria-haspopup=\"true\" aria-expanded=\"false\"></button><ul class=\"navbar-dropdown\"><li><list-link-stub></list-link-stub></li></ul></li>")).toBeTruthy();
  });
});
