...
describe('validate credentials', () => {
    test('validate is empty', () => {
      ...
      expect(res).toEqual({ emptyLogin: true, emptyPassword: true, notValidLogin: true });
    });
    ...
    test('login is not valid', () => {
      ...
      expect(res).toEqual({ emptyLogin: false, emptyPassword: false, notValidLogin: true });
    });
    ...
    test('credentials valid', () => {
      ...
      expect(res).toEqual({ emptyLogin: false, emptyPassword: false, notValidLogin: false });
    });
});
